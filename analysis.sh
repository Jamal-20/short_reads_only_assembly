...
# Define paths
SOURCE_DIR="/home/jamal/03_wgs_assembly/hybrid_genome_assembly_guide_/01_raw_reads/short_reads"
WORK_DIR="/home/jamal/03_wgs_assembly/short_reads_only_assembly"
...
# Rename files to jamal_1.fastq.gz and jamal_2.fastq.gz
cd "${WORK_DIR}/00_raw_reads/"
mv *_1.fastq.gz jamal_1.fastq.gz
mv *_2.fastq.gz jamal_2.fastq.gz
cd -
...
conda activate 01_short_read_qc
fastp \
    -i "${WORK_DIR}/00_raw_reads/jamal_1.fastq.gz" -I "${WORK_DIR}/00_raw_reads/jamal_2.fastq.gz" \
    -o jamal_1_processed.fastq.gz -O jamal_2_processed.fastq.gz \
    -q 25 \
...
fastqc -o reports_fastqc_processed --extract --svg -t 4 "${WORK_DIR}/02_process_reads/"*.fastq.gz
...
spades.py \
    -1 "${WORK_DIR}/02_process_reads/jamal_1_processed.fastq.gz" \
    -2 "${WORK_DIR}/02_process_reads/jamal_2_processed.fastq.gz" \
...
cp "${WORK_DIR}/04_short_reads_only_assembly/spades_output/*.fasta" ./
mv contigs.fasta jk_genome.fasta
